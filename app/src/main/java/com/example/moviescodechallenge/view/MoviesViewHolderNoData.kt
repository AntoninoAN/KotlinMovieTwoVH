...
class MoviesViewHolderNoData(noDataItemView: View):
    ...
    val ivNoDataIcon: ImageView =
        noDataItemView.findViewById(R.id.iv_item_no_data_icon)
    val tvNoDataText: TextView =
        noDataItemView.findViewById(R.id.tv_item_no_data_message)
}